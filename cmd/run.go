...
import (
	...
	"github.com/conflux-fans/rosetta-conflux/services"
...
func runRunCmd(cmd *cobra.Command, args []string) error {
	...
	// requests.
	// asserter, err := &_asserter.Asserter{}, nil
	asserter, err := asserter.NewServer(
		conflux.OperationTypes,
		conflux.HistoricalBalanceSupported,
		[]*types.NetworkIdentifier{cfg.Network},
		conflux.CallMethods,
		conflux.IncludeMempoolCoins,
		"",
	)
	if err != nil {
